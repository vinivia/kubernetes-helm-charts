...
Usage:
{{ include "k8s-common.validations.values.mysql.passwords" (dict "secret" "secretName" "subchart" false "context" $) }}
Params:
  - secret - String - Required. Name of the secret where MySQL values are stored, e.g: "mysql-passwords-secret"
  - subchart - Boolean - Optional. Whether MySQL is used as subchart or not. Default: false
*/}}
{{- define "k8s-common.validations.values.mysql.passwords" -}}
  {{- $existingSecret := include "k8s-common.mysql.values.auth.existingSecret" . -}}
  {{- $enabled := include "k8s-common.mysql.values.enabled" . -}}
  {{- $architecture := include "k8s-common.mysql.values.architecture" . -}}
  {{- $authPrefix := include "k8s-common.mysql.values.key.auth" . -}}
...
Usage:
{{ include "k8s-common.mysql.values.auth.existingSecret" (dict "context" $) }}
Params:
  - subchart - Boolean - Optional. Whether MySQL is used as subchart or not. Default: false
*/}}
{{- define "k8s-common.mysql.values.auth.existingSecret" -}}
  {{- if .subchart -}}
...
Usage:
{{ include "k8s-common.mysql.values.enabled" (dict "context" $) }}
*/}}
{{- define "k8s-common.mysql.values.enabled" -}}
  {{- if .subchart -}}
...
Usage:
{{ include "k8s-common.mysql.values.architecture" (dict "subchart" "true" "context" $) }}
Params:
  - subchart - Boolean - Optional. Whether MySQL is used as subchart or not. Default: false
*/}}
{{- define "k8s-common.mysql.values.architecture" -}}
  {{- if .subchart -}}
...
Usage:
{{ include "k8s-common.mysql.values.key.auth" (dict "subchart" "true" "context" $) }}
Params:
  - subchart - Boolean - Optional. Whether MySQL is used as subchart or not. Default: false
*/}}
{{- define "k8s-common.mysql.values.key.auth" -}}
  {{- if .subchart -}}
    mysql.auth
  {{- else -}}
    auth
