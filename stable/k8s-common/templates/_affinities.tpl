...
{{ include "k8s-common.affinities.pods.soft" (dict "component" "FOO" "context" $) -}}
*/}}
...
preferredDuringSchedulingIgnoredDuringExecution:
  - podAffinityTerm:
      labelSelector:
        matchLabels: {{- (include "k8s-common.labels.matchLabels" .context) | nindent 10 }}
...
{{ include "k8s-common.affinities.pods.hard" (dict "component" "FOO" "context" $) -}}
*/}}
{{- define "k8s-common.affinities.pods.hard" -}}
{{- $component := default "" .component -}}
requiredDuringSchedulingIgnoredDuringExecution:
  - labelSelector:
      matchLabels: {{- (include "k8s-common.labels.matchLabels" .context) | nindent 8 }}
        {{- if not (empty $component) }}
        {{ printf "app.kubernetes.io/component: %s" $component }}
        {{- end }}
    namespaces:
